...
class IdentitySeedDataTests extends AbstractIntegrationTest {
    ...
    void expectedRolesHoldTheirSeededPermissions() {
        ...
        assertThat(permissionCodesOf(RoleName.CASHIER))
                .containsExactlyInAnyOrder("PRODUCT_READ", "CUSTOMER_READ", "CUSTOMER_WRITE", "CREDIT_READ", "CREDIT_WRITE", "SALE_CREATE", "SALE_READ", "PAYMENT_READ", "RECEIPT_READ", "RECEIPT_REPRINT", "REGISTER_OPEN");
