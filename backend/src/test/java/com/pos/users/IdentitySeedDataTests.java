...
class IdentitySeedDataTests extends AbstractIntegrationTest {
    ...
    void seedsExactlyTheIdentityPermissionCodes() {
        ...
        assertThat(codes).containsExactlyInAnyOrder("USER_READ", "USER_WRITE", "USER_ADMIN", "ROLE_READ", "ROLE_WRITE", "STORE_READ", "STORE_WRITE", "TERMINAL_READ", "TERMINAL_WRITE", "REGISTER_READ", "REGISTER_WRITE", "PRODUCT_READ", "PRODUCT_WRITE", "PRODUCT_PRICE_WRITE", "INVENTORY_READ", "INVENTORY_ADJUST", "INVENTORY_RECEIVE", "REPORT_INVENTORY", "CUSTOMER_READ", "CUSTOMER_WRITE", "CREDIT_READ", "CREDIT_WRITE", "SUPPLIER_READ", "SUPPLIER_WRITE", "PURCHASE_READ", "PURCHASE_WRITE", "PURCHASE_APPROVE", "AP_READ", "AP_WRITE", "AP_PAYMENT_CREATE", "SALE_CREATE", "SALE_READ", "PAYMENT_READ", "RECEIPT_READ", "RECEIPT_REPRINT", "REGISTER_OPEN", "REGISTER_CASH", "REGISTER_CLOSE", "SALE_REFUND", "QUOTATION_READ", "QUOTATION_WRITE", "QUOTATION_SEND", "QUOTATION_APPROVE", "QUOTATION_CONVERT", "PROMOTION_READ", "PROMOTION_WRITE", "SALE_DISCOUNT", "ORDER_CREATE", "ORDER_READ", "ORDER_FULFILL", "ORDER_CANCEL", "ORDER_REFUND", "BUDGET_READ", "BUDGET_WRITE", "BUDGET_APPROVE", "EXPENSE_READ", "EXPENSE_WRITE", "REPORT_SALES", "REPORT_FINANCE", "REPORT_CASH");
    }
    ...
    void expectedRolesHoldTheirSeededPermissions() {
        ...
        assertThat(permissionCodesOf(RoleName.STORE_MANAGER))
                .contains("PRODUCT_READ", "PRODUCT_WRITE", "PRODUCT_PRICE_WRITE", "INVENTORY_READ", "INVENTORY_ADJUST", "INVENTORY_RECEIVE", "REPORT_INVENTORY", "CUSTOMER_READ", "CUSTOMER_WRITE", "CREDIT_READ", "CREDIT_WRITE", "SUPPLIER_READ", "SUPPLIER_WRITE", "PURCHASE_READ", "PURCHASE_WRITE", "PURCHASE_APPROVE", "AP_READ", "AP_WRITE", "AP_PAYMENT_CREATE", "SALE_CREATE", "SALE_READ", "PAYMENT_READ", "RECEIPT_READ", "RECEIPT_REPRINT", "REGISTER_OPEN", "REGISTER_CASH", "REGISTER_CLOSE", "SALE_REFUND", "QUOTATION_READ", "QUOTATION_WRITE", "QUOTATION_SEND", "QUOTATION_APPROVE", "QUOTATION_CONVERT", "PROMOTION_READ", "PROMOTION_WRITE", "SALE_DISCOUNT", "ORDER_CREATE", "ORDER_READ", "ORDER_FULFILL", "ORDER_CANCEL", "ORDER_REFUND", "BUDGET_READ", "BUDGET_WRITE", "BUDGET_APPROVE", "EXPENSE_READ", "EXPENSE_WRITE", "REPORT_SALES", "REPORT_FINANCE", "REPORT_CASH");
        assertThat(permissionCodesOf(RoleName.INVENTORY_MANAGER))
                .contains("PRODUCT_READ", "PRODUCT_WRITE", "PRODUCT_PRICE_WRITE", "INVENTORY_READ", "INVENTORY_ADJUST", "INVENTORY_RECEIVE", "REPORT_INVENTORY", "SUPPLIER_READ", "SUPPLIER_WRITE", "PURCHASE_READ", "PURCHASE_WRITE", "PURCHASE_APPROVE");
        assertThat(permissionCodesOf(RoleName.CASHIER))
                .contains("PRODUCT_READ", "CUSTOMER_READ", "CUSTOMER_WRITE", "CREDIT_READ", "CREDIT_WRITE", "SALE_CREATE", "SALE_READ", "PAYMENT_READ", "RECEIPT_READ", "RECEIPT_REPRINT", "REGISTER_OPEN", "REGISTER_CASH", "REGISTER_CLOSE");

        assertThat(permissionCodesOf(RoleName.ACCOUNTANT))
                .contains("REPORT_INVENTORY", "SUPPLIER_READ", "SUPPLIER_WRITE", "AP_READ", "AP_WRITE", "AP_PAYMENT_CREATE");
    }
